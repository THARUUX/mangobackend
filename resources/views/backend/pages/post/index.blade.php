...
<div class="page-header">
    <h1 class="page-title my-auto">Posts</h1>
    <div>
            ...
            <div class="col-12 d-inline-block mb-3">
                <div class="d-inline-flex float-end">
                    <button class="btn btn-primary d-flex align-items-center gap-2"
                        onclick="window.location='/admin/blog/create'">
                    ...
                    <div class="col-12 col-xl-8 mt-3 mt-xl-0 right-panel">
                        <div class="row align-items-center justify-content-end">
                            ...
                            <div class="col-3 col-xl-2">
                                <select id="filterStatus" class="form-select" onchange="updateFilters('blog')">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <li>
                                                        <a class="dropdown-item d-flex align-items-center gap-2"
                                                            onclick="window.location='/admin/edit-blog/{{ $data->id }}'"><i
                                                                class="fi fi-rr-edit"></i> Edit</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item d-flex align-items-center gap-2"
                                                            onclick="deletePost({{ $data->id }}, this)"><i
